...
using Implementation.UseCases.Commands.packings;
...

{
    public static class ContainerExtensions
    {
        public static void AddUseCases(this IServiceCollection services)
        {
            ...
            //Packings
            services.AddTransient<ICreatePackingCommand, EfCreatePackingCommand>();
            services.AddTransient<CreatePackingValidator>();
            services.AddTransient<IUpdatePackingCommand, EfUpdatePackingCommand>();
            services.AddTransient<UpdatePackingValidator>();
